...
*"A computer program is said to learn from experience $\text{E}$ with respect to some class of tasks $\text{T}$, and performance measure $\text{P}$, if its performance at tasks in $\text{T}$, as measured by $\text{P}$, improves with experience $\text{E}$. (Tom Mitchell)"*
