...
plt.show()
{{< /highlight >}}
{{< figure src="/Visualization/fig1.1.png">}}
...
plt.show()
{{< /highlight >}}
{{< figure src="/Visualization/fig1.2.png">}}
...
plt.show()
{{< /highlight >}}
{{< figure src="/Visualization/fig1.3.png">}}
...
plt.show()
{{< /highlight >}}
{{< figure src="/Visualization/fig1.4.png">}}
...
plt.show()
{{< /highlight >}}
![fig 1.5](/Visualization/fig1.5.png)
